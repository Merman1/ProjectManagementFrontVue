          ...
          <div class="px-[20px]">
            ...
            <div class="flex space-x-4 mb-8">
              <router-link to="/editUser"
                class="bg-amber-300 text-white px-4 py-2 rounded-md shadow-md transition duration-300 hover:bg-amber-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">Edytuj
                dane osobowe</router-link>
              <router-link to="/editContact"
                class="bg-amber-300 text-white px-4 py-2 rounded-md shadow-md transition duration-300 hover:bg-amber-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">Edytuj
                dane kontaktowe</router-link>
              <router-link to="/editLogins"
                class="bg-amber-300 text-white px-4 py-2 rounded-md shadow-md transition duration-300 hover:bg-amber-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">Zmień
                hasło</router-link>
            </div>
              ...
              <div class="bg-gray-50 px-6 py-8 rounded-md shadow-md w-full space-y-8 max-w-md text-left">
                ...
                <form>
                  <div class="mb-6">
                    ...
                    <label for="firstName" class="block text-lg font-medium text-gray-700 mb-2">{{ userData.firstName }}
                    </label>
                  </div>
                  <div class="mb-6">
                    <label for="lastNme" class="block text-lg font-medium text-gray-700 mb-2">Nazwisko </label>
                    <label for="lastName" class="block text-lg font-medium text-gray-700 mb-2">{{ userData.lastName }}
                    </label>
                  </div>
                  <div class="mb-6">
                    <label for="positionName" class="block text-lg font-medium text-gray-700 mb-2">Nazwa
                      stanowiska</label>
                    <label for="positionName" class="block text-lg font-medium text-gray-700 mb-2">{{
                      userData.positionName }} </label>
                  </div>
                  <div class="mb-6">
                    <label for="adress" class="block text-lg font-medium text-gray-700 mb-2">Miejscowość</label>
                    <label for="adress" class="block text-lg font-medium text-gray-700 mb-2">{{ userData.adress }}
                    </label>
                  </div>
                </form>
              </div>
              <div class="bg-gray-50 px-6 py-8 rounded-md shadow-md w-full space-y-8 max-w-md text-left">
                <div class="bg-cyan-700 px-6 py-8 rounded-md shadow-md w-full text-white text-left">Dane kontaktowe
                </div>
                <form>
                  <div class="mb-6">
                    <label for="email" class="block text-lg font-medium text-gray-700 mb-2">Adres email</label>
                    <label for="email" class="block text-lg font-medium text-gray-700 mb-2">{{ userData.email }}
                    </label>
                  </div>
                  <div class="mb-6">
                    <label for="number" class="block text-lg font-medium text-gray-700 mb-2">Telefon</label>
                    <label for="number" class="block text-lg font-medium text-gray-700 mb-2">{{ userData.number }}
                    </label>
                  </div>
                  <div class="mb-6">
                    <label for="location" class="block text-lg font-medium text-gray-700 mb-2">Lokalizacja</label>
                    <label for="location" class="block text-lg font-medium text-gray-700 mb-2">{{ userData.location }}
                    </label>
                  </div>
                  <div class="mb-6">
                    <label for="organization" class="block text-lg font-medium text-gray-700 mb-2">Organizacja</label>
                    <label for="organization" class="block text-lg font-medium text-gray-700 mb-2">{{
