    ...
    <div class="w-full h-full bg-gray-400">
      ...
      <div class="h-[calc(100vh-50px)] bg-gray-50 p-[20px]">
        <div class="border border-gray-300 rounded-md p-[20px] h-full">
          <div class="px-[20px]">
            <h3 class="font-bold text-left text-xl mb-4">EDYTUJ DANE KONTAKTOWE</h3>
              ...
              <div class="bg-gray-50 px-6 py-8 rounded-md shadow-md w-full space-y-8 max-w-md text-left">
                ...
                <form @submit.prevent="updateProject2">
                  <div class="mb-6">
                    ...
                    <input type="text" v-model="userData2.email" id="email" name="email" autocomplete="email"
                  ...
                  <div class="mb-6">
                    ...
                    <input type="text" v-model="userData2.number" id="number" name="number" autocomplete="number"
                      class="mt-1 focus:ring-gray-50 focus:border-gray-50 block w-full shadow-sm sm:text-sm border-gray-50 rounded-md px-4 py-3">
                  </div>
                  <div class="mb-6">
                    <label for="location" class="block text-lg font-medium text-gray-700 mb-2">Lokalizacja</label>
                    <input type="text" v-model="userData2.location" id="location" name="location"
                      autocomplete="location"
                      class="mt-1 focus:ring-gray-50 focus:border-gray-50 block w-full shadow-sm sm:text-sm border-gray-50 rounded-md px-4 py-3">
                  </div>
                  <div class="mb-6">
                    <label for="organization" class="block text-lg font-medium text-gray-700 mb-2">Organizacja</label>
                    <input type="text" v-model="userData2.organization" id="organization" name="organization"
