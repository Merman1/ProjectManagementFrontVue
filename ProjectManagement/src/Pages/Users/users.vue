  ...
  <div class="w-screen h-screen flex">
    ...
    <div class="w-full h-full bg-gray-400">
      ...
      <div class="h-[calc(100vh-50px)] bg-gray-50 p-[20px] flex">
        <div class="border border-gray-300 rounded-md p-[20px] h-full w-1/2 mr-[20px]">
          ...
          <ul class="mt-4">
            <li v-for="(user, index) in users" :key="index" class="flex justify-between items-center mb-2">
              ...
              <div class="w-1/12">
                <img src="../../assets/delete.png" alt="Więcej opcji" class="w-4 h-4 cursor-pointer"
                  @click="showConfirmation(user.username)">
              </div>
            </li>
          </ul>
        </div>
          ...
          <form class="mt-4" @submit.prevent="addUser">
            <div class="mb-4">
              ...
              <input v-model="newUser.username" type="text" id="username" name="username"
                class="w-full border-gray-300 rounded-md p-2" placeholder="Wpisz nazwę użytkownika" required>
            </div>
            <div class="mb-4">
              <label for="email" class="block text-gray-700 font-bold mb-2">Email:</label>
              <input v-model="newUser.email" type="email" id="email" name="email"
                class="w-full border-gray-300 rounded-md p-2" placeholder="Wpisz adres email" required>
            </div>
            <div class="mb-4">
              ...
              <input v-model="newUser.password" type="password" id="password" name="password"
                class="w-full border-gray-300 rounded-md p-2" placeholder="Wpisz hasło" required>
            </div>
            <div class="mb-4">
              <label for="role" class="block text-gray-700 font-bold mb-2">Rola:</label>
              <select v-model="newUser.role" id="role" name="role" class="w-full border-gray-300 rounded-md p-2"
                required>
            ...
            <button type="submit" class="bg-amber-300 hover:bg-amber-500 text-white px-4 py-2 rounded-md">Dodaj
              użytkownika</button>
          </form>
        </div>
      </div>
